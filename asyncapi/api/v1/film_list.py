...
async def film_list_with_filter(request: Request, film_list_service: FilmService = Depends(get_film_service)) -> List[FilmResponse]:
...
async def film_search(request: Request, film_list_service: FilmService = Depends(get_film_service)) -> List[FilmResponse]:
